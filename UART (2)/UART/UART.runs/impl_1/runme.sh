...
HD_PWD='D:/01. PROJECT/07.PMSS/FPGA/New folder/PMSS_RTD/UART/UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CH1_RTD.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CH1_RTD.tcl -notrace
