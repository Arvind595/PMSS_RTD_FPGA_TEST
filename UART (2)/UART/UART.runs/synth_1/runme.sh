...
HD_PWD='D:/01. PROJECT/07.PMSS/FPGA/New folder/PMSS_RTD/UART/UART.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CH1_RTD.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CH1_RTD.tcl
