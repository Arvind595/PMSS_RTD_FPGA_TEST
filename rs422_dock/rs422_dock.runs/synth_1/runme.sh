...
HD_PWD='D:/MSPL WORK/PMSS/RTL/PMSS_FPGA_RTD_TEST/PMSS_RTD_FPGA_TEST/rs422_dock/rs422_dock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rs422_dock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rs422_dock.tcl
