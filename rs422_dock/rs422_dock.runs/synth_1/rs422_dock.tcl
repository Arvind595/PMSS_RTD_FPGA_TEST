...
synth_design -top rs422_dock -part xc7a100tcsg324-2
...
write_checkpoint -force -noxdef rs422_dock.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file rs422_dock_utilization_synth.rpt -pb rs422_dock_utilization_synth.pb"  } 
